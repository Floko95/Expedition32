Shader "Ciconia Studio/CS_Glass/HDRP/Glass(IOR)"
{
	Properties
	{
		...
		[Space(10)][Header(Main Properties________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)][Space(15)]_Color("Color", Color) = (0,0,0,0)
		...
		[Space(45)][Header(Glass Properties________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________) ][Space(15)]_GlassColor("Glass Color", Color) = (1,1,1,0)
		[Space(10)]_IndexofRefraction("Index of Refraction", Float) = 1.3
		_GlassThickness("Glass Thickness", Float) = 1
		[Space(20)]_IridescentMaskMap("Iridescent Mask Map", 2D) = "white" {}
		[Space(10)]_IridescentThickness("Iridescent Thickness", Range( 0 , 1)) = 0.1
		...
		[Space(45)][Header(Decal Properties________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)][Space(15)]_ColorDecal("Color -->(Transparency A)", Color) = (1,1,1,1)
		...
		_BumpScaleDecal("Scale", Range( 0 , 1)) = 0.1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 tex2DNode76 = tex2D( _MainTex, ( appendResult14_g11 + appendResult13_g11 ) );
				...
				float2 uv_DetailAlbedoMap = packedInput.ase_texcoord5.xyz.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				...
				float2 break26_g15 = uv_BumpMap;
				float2 appendResult14_g15 = (float2(( break26_g15.x * GlobalTilingX281 ) , ( break26_g15.y * GlobalTilingY282 )));
				float2 appendResult13_g15 = (float2(( break26_g15.x + GlobalOffsetX493 ) , ( break26_g15.y + GlobalOffsetY496 )));
				float3 unpack2 = UnpackNormalScale( tex2D( _BumpMap, ( appendResult14_g15 + appendResult13_g15 ) ), _BumpScale );
				unpack2.z = lerp( 1, unpack2.z, saturate(_BumpScale) );
				float3 tex2DNode2 = unpack2;
				float2 uv_DetailNormalMap = packedInput.ase_texcoord5.xyz.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				...
				float2 uv_MetallicGlossMap = packedInput.ase_texcoord5.xyz.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float2 break26_g12 = uv_MetallicGlossMap;
				...
				float fresnelNdotV163 = dot( normalWS, V );
				...
				float3 worldRefl3 = reflect( -V, float3( dot( tanToWorld0, NormalmapXYZ170 ), dot( tanToWorld1, NormalmapXYZ170 ), dot( tanToWorld2, NormalmapXYZ170 ) ) );
				...
				#endif
				float4 temp_output_169_0 = ( ( ( ifLocalVar474 * ( _FresnelStrength * 1000 ) ) * staticSwitch457 ) + ( texCUBENode6 * ( ( texCUBENode6.a * _ReflectionIntensity ) * 1000 ) * _ColorCubemap ) );
				...
				float2 uv_OcclusionMap = packedInput.ase_texcoord5.xyz.xy * _OcclusionMap_ST.xy + _OcclusionMap_ST.zw;
				float2 break26_g13 = uv_OcclusionMap;
				float2 appendResult14_g13 = (float2(( break26_g13.x * GlobalTilingX281 ) , ( break26_g13.y * GlobalTilingY282 )));
				float2 appendResult13_g13 = (float2(( break26_g13.x + GlobalOffsetX493 ) , ( break26_g13.y + GlobalOffsetY496 )));
				...
				float clampResult570 = clamp( _GlassThickness , 0.0 , 100.0 );
				float Thickness561 = clampResult570;
				
				float IOR103 = _IndexofRefraction;
				
				float4 RefractionColor548 = _GlassColor;
				
				float2 uv_IridescentMaskMap = packedInput.ase_texcoord5.xyz.xy * _IridescentMaskMap_ST.xy + _IridescentMaskMap_ST.zw;
				float IridescenceMask562 = tex2D( _IridescentMaskMap, uv_IridescentMaskMap ).a;
				
				float IridescentThickness563 = (0.0 + (_IridescentThickness - 0.1) * (1.0 - 0.0) / (1.0 - 0.1));
				
				surfaceDescription.BaseColor = AlbedoAmbient117.rgb;
				surfaceDescription.Normal = Normal101;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = Metallic110;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = Cubmap179.rgb;
				surfaceDescription.Smoothness = Roughness111;
				surfaceDescription.Occlusion = Occlusion140;
				surfaceDescription.Alpha = Opacity87;
				...
				#if defined(_HAS_REFRACTION) || defined(_MATERIAL_FEATURE_TRANSMISSION)
				surfaceDescription.Thickness = Thickness561;
				#endif

				#ifdef _HAS_REFRACTION
				surfaceDescription.RefractionIndex = IOR103;
				surfaceDescription.RefractionColor = RefractionColor548.rgb;
				...
				#ifdef _MATERIAL_FEATURE_IRIDESCENCE
				surfaceDescription.IridescenceMask = IridescenceMask562;
				surfaceDescription.IridescenceThickness = IridescentThickness563;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 desaturateVar211 = lerp( desaturateInitialColor211, desaturateDot211.xxx, -clampResult239 );
				float4 temp_output_303_0 = CalculateContrast(_Brightness,float4( desaturateVar211 , 0.0 ));
				float2 uv_DetailAlbedoMap = packedInput.ase_texcoord2.xyz.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float cos400 = cos( radians( _Rotation ) );
				float sin400 = sin( radians( _Rotation ) );
				float2 rotator400 = mul( uv_DetailAlbedoMap - float2( 0.5,0.5 ) , float2x2( cos400 , -sin400 , sin400 , cos400 )) + float2( 0.5,0.5 );
				float4 tex2DNode181 = tex2D( _DetailAlbedoMap, rotator400 );
				...
				float2 uv_BumpMap = packedInput.ase_texcoord2.xyz.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float2 break26_g15 = uv_BumpMap;
				float2 appendResult14_g15 = (float2(( break26_g15.x * GlobalTilingX281 ) , ( break26_g15.y * GlobalTilingY282 )));
				float2 appendResult13_g15 = (float2(( break26_g15.x + GlobalOffsetX493 ) , ( break26_g15.y + GlobalOffsetY496 )));
				float3 unpack2 = UnpackNormalScale( tex2D( _BumpMap, ( appendResult14_g15 + appendResult13_g15 ) ), _BumpScale );
				unpack2.z = lerp( 1, unpack2.z, saturate(_BumpScale) );
				float3 tex2DNode2 = unpack2;
				float2 uv_DetailNormalMap = packedInput.ase_texcoord2.xyz.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				float Rotator_Detailsmaps411 = _Rotation;
				float cos409 = cos( radians( Rotator_Detailsmaps411 ) );
				float sin409 = sin( radians( Rotator_Detailsmaps411 ) );
				float2 rotator409 = mul( uv_DetailNormalMap - float2( 0.5,0.5 ) , float2x2( cos409 , -sin409 , sin409 , cos409 )) + float2( 0.5,0.5 );
				...
				float2 uv_MetallicGlossMap = packedInput.ase_texcoord2.xyz.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float2 break26_g12 = uv_MetallicGlossMap;
				float2 appendResult14_g12 = (float2(( break26_g12.x * GlobalTilingX281 ) , ( break26_g12.y * GlobalTilingY282 )));
				float2 appendResult13_g12 = (float2(( break26_g12.x + GlobalOffsetX493 ) , ( break26_g12.y + GlobalOffsetY496 )));
				float4 tex2DNode123 = tex2D( _MetallicGlossMap, ( appendResult14_g12 + appendResult13_g12 ) );
				...
				float2 uv_OcclusionMap = packedInput.ase_texcoord2.xyz.xy * _OcclusionMap_ST.xy + _OcclusionMap_ST.zw;
				float2 break26_g13 = uv_OcclusionMap;
				float2 appendResult14_g13 = (float2(( break26_g13.x * GlobalTilingX281 ) , ( break26_g13.y * GlobalTilingY282 )));
				float2 appendResult13_g13 = (float2(( break26_g13.x + GlobalOffsetX493 ) , ( break26_g13.y + GlobalOffsetY496 )));
				float blendOpSrc136 = tex2D( _OcclusionMap, ( appendResult14_g13 + appendResult13_g13 ) ).r;
				...
				float2 uv_IridescentMaskMap = packedInput.ase_texcoord2.xyz.xy * _IridescentMaskMap_ST.xy + _IridescentMaskMap_ST.zw;
				float IridescenceMask562 = tex2D( _IridescentMaskMap, uv_IridescentMaskMap ).a;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float4 tex2DNode123 = tex2D( _MetallicGlossMap, ( appendResult14_g12 + appendResult13_g12 ) );
				float RougnessA370 = tex2DNode123.a;
				float2 uv_DetailAlbedoMap = packedInput.ase_texcoord2.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float cos400 = cos( radians( _Rotation ) );
				float sin400 = sin( radians( _Rotation ) );
				float2 rotator400 = mul( uv_DetailAlbedoMap - float2( 0.5,0.5 ) , float2x2( cos400 , -sin400 , sin400 , cos400 )) + float2( 0.5,0.5 );
				float4 tex2DNode181 = tex2D( _DetailAlbedoMap, rotator400 );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float3 tex2DNode194 = unpack194;
				float3 lerpResult308 = lerp( tex2DNode194 , BlendNormal( tex2DNode2 , tex2DNode194 ) , _BumpScaleDecal1);
				float2 uv_DetailAlbedoMap = packedInput.ase_texcoord3.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float cos400 = cos( radians( _Rotation ) );
				float sin400 = sin( radians( _Rotation ) );
				float2 rotator400 = mul( uv_DetailAlbedoMap - float2( 0.5,0.5 ) , float2x2( cos400 , -sin400 , sin400 , cos400 )) + float2( 0.5,0.5 );
				float4 tex2DNode181 = tex2D( _DetailAlbedoMap, rotator400 );
		...
		Pass
		{
						...
						)
			{
				...
				float3 desaturateVar211 = lerp( desaturateInitialColor211, desaturateDot211.xxx, -clampResult239 );
				float4 temp_output_303_0 = CalculateContrast(_Brightness,float4( desaturateVar211 , 0.0 ));
				float2 uv_DetailAlbedoMap = packedInput.ase_texcoord7.xyz.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float cos400 = cos( radians( _Rotation ) );
				float sin400 = sin( radians( _Rotation ) );
				float2 rotator400 = mul( uv_DetailAlbedoMap - float2( 0.5,0.5 ) , float2x2( cos400 , -sin400 , sin400 , cos400 )) + float2( 0.5,0.5 );
				float4 tex2DNode181 = tex2D( _DetailAlbedoMap, rotator400 );
				...
				unpack2.z = lerp( 1, unpack2.z, saturate(_BumpScale) );
				float3 tex2DNode2 = unpack2;
				float2 uv_DetailNormalMap = packedInput.ase_texcoord7.xyz.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				float Rotator_Detailsmaps411 = _Rotation;
				float cos409 = cos( radians( Rotator_Detailsmaps411 ) );
				float sin409 = sin( radians( Rotator_Detailsmaps411 ) );
				float2 rotator409 = mul( uv_DetailNormalMap - float2( 0.5,0.5 ) , float2x2( cos409 , -sin409 , sin409 , cos409 )) + float2( 0.5,0.5 );
				...
				float2 uv_MetallicGlossMap = packedInput.ase_texcoord7.xyz.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float2 break26_g12 = uv_MetallicGlossMap;
				float2 appendResult14_g12 = (float2(( break26_g12.x * GlobalTilingX281 ) , ( break26_g12.y * GlobalTilingY282 )));
				float2 appendResult13_g12 = (float2(( break26_g12.x + GlobalOffsetX493 ) , ( break26_g12.y + GlobalOffsetY496 )));
				float4 tex2DNode123 = tex2D( _MetallicGlossMap, ( appendResult14_g12 + appendResult13_g12 ) );
				...
				float2 uv_OcclusionMap = packedInput.ase_texcoord7.xyz.xy * _OcclusionMap_ST.xy + _OcclusionMap_ST.zw;
				float2 break26_g13 = uv_OcclusionMap;
				float2 appendResult14_g13 = (float2(( break26_g13.x * GlobalTilingX281 ) , ( break26_g13.y * GlobalTilingY282 )));
				float2 appendResult13_g13 = (float2(( break26_g13.x + GlobalOffsetX493 ) , ( break26_g13.y + GlobalOffsetY496 )));
				float blendOpSrc136 = tex2D( _OcclusionMap, ( appendResult14_g13 + appendResult13_g13 ) ).r;
				...
				float2 uv_IridescentMaskMap = packedInput.ase_texcoord7.xyz.xy * _IridescentMaskMap_ST.xy + _IridescentMaskMap_ST.zw;
				float IridescenceMask562 = tex2D( _IridescentMaskMap, uv_IridescentMaskMap ).a;
		...
		Pass
        {
					...
					)
			{
				...
				ase_worldViewDir = normalize(ase_worldViewDir);
				float lerpResult68 = lerp( -3.0 , 0.0 , _FalloffOpacityIntensity);
				float fresnelNdotV25 = dot( packedInput.normalWS, ase_worldViewDir );
				float fresnelNode25 = ( lerpResult68 + _PowerFalloffOpacity * pow( max( 1.0 - fresnelNdotV25 , 0.0001 ), (( 1.0 + -_Opacity ) + (1.0 - 0.0) * (_Opacity - ( 1.0 + -_Opacity )) / (1.0 - 0.0)) ) );
				float clampResult45 = clamp( (( _Invert )?( ( 1.0 - fresnelNode25 ) ):( fresnelNode25 )) , 0.0 , 1.0 );
				float2 uv_MainTex = packedInput.ase_texcoord3.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float2 break26_g11 = uv_MainTex;
